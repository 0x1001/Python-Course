...
File Course/Lesson_5/pllsettings_template.py is a solution template that you can use as starting point. Copy it to your solution folder and rename it to pllsettings.py.